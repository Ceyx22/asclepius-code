...
"""Launch HW5 P5
   ...
   ros2 launch hw5sols hw5p5sol.launch.py

This should start
  1) The robot_state_publisher to broadcast the robot model
  2) The HW5 P5 solution code to move the joints
...
def generate_launch_description():
    ...
    rvizcfg = os.path.join(pkgdir('asclepius'), 'rviz/viewurdf.rviz')

    # Locate the URDF file.
    urdf = os.path.join(pkgdir('asclepius'), 'description/threeDOF.urdf')
