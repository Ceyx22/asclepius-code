#include "endeffector_controller/endeffector_controller.hpp"
#include <stddef.h>
#include <algorithm>
#include <memory>
#include <string>
...
{
    EndeffectorController::EndeffectorController() : controller_interface::ControllerInterface() {}

    controller_interface::CallbackReturn EndeffectorController::on_init()
    {
    ...
    controller_interface::InterfaceConfiguration EndeffectorController::command_interface_configuration()
        const
    {
    ...
    controller_interface::InterfaceConfiguration EndeffectorController::state_interface_configuration() const
    {
        controller_interface::InterfaceConfiguration conf = {config_type::INDIVIDUAL, {}};
    ...
    controller_interface::CallbackReturn EndeffectorController::on_configure(const rclcpp_lifecycle::State &)
    {
        auto callback =
    ...
    controller_interface::CallbackReturn EndeffectorController::on_activate(const rclcpp_lifecycle::State &)
    {
    ...
    controller_interface::return_type EndeffectorController::update(
    ...
    controller_interface::CallbackReturn EndeffectorController::on_deactivate(const rclcpp_lifecycle::State &)
    {
        release_interfaces();
    ...
    controller_interface::CallbackReturn EndeffectorController::on_cleanup(const rclcpp_lifecycle::State &)
    {
        return CallbackReturn::SUCCESS;
    }

    controller_interface::CallbackReturn EndeffectorController::on_error(const rclcpp_lifecycle::State &)
    {
        return CallbackReturn::SUCCESS;
    }

    controller_interface::CallbackReturn EndeffectorController::on_shutdown(const rclcpp_lifecycle::State &)
    {
        return CallbackReturn::SUCCESS;
    }
...
PLUGINLIB_EXPORT_CLASS(endeffector_controller::EndeffectorController, controller_interface::ControllerInterface);